...
public class PanelCadastrarTurma extends JPanel {
	...
	public JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("Preencha com informações da turma:");
	...
	public JLabel getLblAnoEscolar() {
		if (lblAnoEscolar == null) {
			lblAnoEscolar = new JLabel("selecione a sériie ");
	...
	public JLabel getLblTipoPeriodo() {
		if (lblTipoPeriodo == null) {
			lblTipoPeriodo = new JLabel("turna:");
