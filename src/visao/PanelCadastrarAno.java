...
public class PanelCadastrarAno extends JPanel {
	...
	public JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("Preencha com informações do ano escolar:");
	...
	public JComboBox getComboBox() {
		if (comboBox == null) {
			...
			comboBox.setBounds(292, 167, 200, 30);
		}
		return comboBox;
	}
	...
	public JTextField getTextFieldAnoEscolar() {
		if (textFieldAnoEscolar == null) {
			...
			textFieldAnoEscolar.setBounds(292, 86, 200, 30);
		}
